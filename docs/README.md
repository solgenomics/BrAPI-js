...
| [`/observationLevels`]()                                                                                                                                                 | _node_.observationLevels(...)            | `GET`               |
| [`/ontologies`]()                                                                                                                                                        | _node_.ontologies(...)                   | `GET`               |
| [`/phenotypes-search`]()                                                                                                                                                 | _node_.phenotypes_search(...)            | `POST`              |
| [`/programs`]()                                                                                                                                                          | _node_.programs(...)                     | `GET`               |
| [`/programs-search`]()                                                                                                                                                   | _node_.programs_search(...)              | `POST`              |
| [`/samples-search`]()                                                                                                                                                    | _node_.samples_search(...)               | `POST`              |
| [`/samples/{samplesDbId}`]()                                                                                                                                             | _node_.samples(...)                      | `GET`               |
| [`/seasons`]()                                                                                                                                                           | _node_.seasons(...)                      | `GET`               |
| [`/studies-search`]()                                                                                                                                                    | _node_.studies_search(...)               | `POST`              |
| [`/studies/{studiesDbId}`]()                                                                                                                                             | _node_.studies(...)                      | `GET`               |
| [`/studies/{studiesDbId}/germplasm`]()                                                                                                                                   | _node_.studies_germplasm(...)            | `GET`               |
| [`/studies/{studiesDbId}/layout`]()                                                                                                                                      | _node_.studies_layout(...)               | `GET`               |
| [`/studies/{studiesDbId}/observations`]()                                                                                                                                | _node_.studies_observations(...)         | `GET`               |
| [`/studies/{studiesDbId}/observationunits`]()                                                                                                                            | _node_.studies_observationunits(...)     | `GET`               |
| [`/studies/{studiesDbId}/observationvariables`]()                                                                                                                        | _node_.studies_observationvariables(...) | `GET`               |
| [`/studies/{studiesDbId}/table`]()                                                                                                                                       | _node_.studies_table(...)                | `GET`               |
| [`/studytypes`]()                                                                                                                                                        | _node_.studytypes(...)                   | `GET`               |
| [`/traits `]()                                                                                                                                                           | _node_.traits_list(...)                  | `GET`               |
| [`/traits/{traitDbId}`]()                                                                                                                                                | _node_.traits(...)                       | `GET`               |
| [`/trials`]()                                                                                                                                                            | _node_.trials_list(...)                  | `GET`               |
| [`/trials/{trialDbId}`]()                                                                                                                                                | _node_.trials(...)                       | `GET`               |
| [`/variables-search`]()                                                                                                                                                  | _node_.variables_search(...)             | `POST`              |
| [`/variables`]()                                                                                                                                                         | _node_.variables_list(...)               | `GET`               |
| [`/variables/{variableDbId}`]()                                                                                                                                          | _node_.variables(...)                    | `GET`               |
| [`/variables/datatypes`]()                                                                                                                                               | _node_.variables_datatypes(...)          | `GET`               |
